...
// GetRootIndex is a free data retrieval call binding the contract method 0xda0afd48.
//
// Solidity: function getRootIndex(bytes32 root) view returns(uint32)
func (_ContractIPaymentCoordinator *ContractIPaymentCoordinatorCaller) GetRootIndex(opts *bind.CallOpts, root [32]byte) (uint32, error) {
	var out []interface{}
	err := _ContractIPaymentCoordinator.contract.Call(opts, &out, "getRootIndex", root)
...
//
// Solidity: function getRootIndex(bytes32 root) view returns(uint32)
func (_ContractIPaymentCoordinator *ContractIPaymentCoordinatorSession) GetRootIndex(root [32]byte) (uint32, error) {
	return _ContractIPaymentCoordinator.Contract.GetRootIndex(&_ContractIPaymentCoordinator.CallOpts, root)
}

// GetRootIndex is a free data retrieval call binding the contract method 0xda0afd48.
//
// Solidity: function getRootIndex(bytes32 root) view returns(uint32)
func (_ContractIPaymentCoordinator *ContractIPaymentCoordinatorCallerSession) GetRootIndex(root [32]byte) (uint32, error) {
	return _ContractIPaymentCoordinator.Contract.GetRootIndex(&_ContractIPaymentCoordinator.CallOpts, root)
}
...
//
// Solidity: function setClaimer(address earner, address claimer) returns()
func (_ContractIPaymentCoordinator *ContractIPaymentCoordinatorTransactor) SetClaimer(opts *bind.TransactOpts, earner common.Address, claimer common.Address) (*types.Transaction, error) {
	return _ContractIPaymentCoordinator.contract.Transact(opts, "setClaimer", earner, claimer)
}

// SetClaimer is a paid mutator transaction binding the contract method 0xf5cf673b.
//
// Solidity: function setClaimer(address earner, address claimer) returns()
func (_ContractIPaymentCoordinator *ContractIPaymentCoordinatorSession) SetClaimer(earner common.Address, claimer common.Address) (*types.Transaction, error) {
	return _ContractIPaymentCoordinator.Contract.SetClaimer(&_ContractIPaymentCoordinator.TransactOpts, earner, claimer)
}

// SetClaimer is a paid mutator transaction binding the contract method 0xf5cf673b.
//
// Solidity: function setClaimer(address earner, address claimer) returns()
func (_ContractIPaymentCoordinator *ContractIPaymentCoordinatorTransactorSession) SetClaimer(earner common.Address, claimer common.Address) (*types.Transaction, error) {
	return _ContractIPaymentCoordinator.Contract.SetClaimer(&_ContractIPaymentCoordinator.TransactOpts, earner, claimer)
}
...
// SubmitRoot is a paid mutator transaction binding the contract method 0xd939c4c4.
//
// Solidity: function submitRoot(bytes32 root, uint64 paymentCalculationEndTimestamp, uint64 activatedAt) returns()
func (_ContractIPaymentCoordinator *ContractIPaymentCoordinatorTransactor) SubmitRoot(opts *bind.TransactOpts, root [32]byte, paymentCalculationEndTimestamp uint64, activatedAt uint64) (*types.Transaction, error) {
	return _ContractIPaymentCoordinator.contract.Transact(opts, "submitRoot", root, paymentCalculationEndTimestamp, activatedAt)
}

// SubmitRoot is a paid mutator transaction binding the contract method 0xd939c4c4.
//
// Solidity: function submitRoot(bytes32 root, uint64 paymentCalculationEndTimestamp, uint64 activatedAt) returns()
func (_ContractIPaymentCoordinator *ContractIPaymentCoordinatorSession) SubmitRoot(root [32]byte, paymentCalculationEndTimestamp uint64, activatedAt uint64) (*types.Transaction, error) {
	return _ContractIPaymentCoordinator.Contract.SubmitRoot(&_ContractIPaymentCoordinator.TransactOpts, root, paymentCalculationEndTimestamp, activatedAt)
}

// SubmitRoot is a paid mutator transaction binding the contract method 0xd939c4c4.
//
// Solidity: function submitRoot(bytes32 root, uint64 paymentCalculationEndTimestamp, uint64 activatedAt) returns()
func (_ContractIPaymentCoordinator *ContractIPaymentCoordinatorTransactorSession) SubmitRoot(root [32]byte, paymentCalculationEndTimestamp uint64, activatedAt uint64) (*types.Transaction, error) {
	return _ContractIPaymentCoordinator.Contract.SubmitRoot(&_ContractIPaymentCoordinator.TransactOpts, root, paymentCalculationEndTimestamp, activatedAt)
}
